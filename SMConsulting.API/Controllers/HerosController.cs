...
namespace SMConsulting.API.Controllers
{
    ...
    [ApiController]
    public class HerosController(IHeroService _service) : ControllerBase
    {
        // GET: api/<HerosController>
        [HttpGet]
        [AllowAnonymous]
        ...
        [HttpPost]
        public async Task<IActionResult> Create(HeroCreateDto dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, HeroUpdateDto dto)
        {
